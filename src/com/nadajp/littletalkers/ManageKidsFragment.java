   ...
   public View onCreateView(LayoutInflater inflater, ViewGroup container,
	...
	public void onActivityCreated(Bundle savedInstanceState)
	{
      ...
      if (cursor.getCount() == 0)
      {
   	...
   	mCursorAdapter = new SimpleCursorAdapter(this.getActivity(), android.R.layout.simple_list_item_activated_1, cursor, adapterCols, adapterRowViews,0);
      ...
      public Dialog onCreateDialog(Bundle savedInstanceState) 
	   {
         ...
         builder.setMessage(R.string.delete_kids_dialog)
                .setPositiveButton(R.string.delete, new DialogInterface.OnClickListener() 
            {
               public void onClick(DialogInterface dialog, int id) 
               {	                    	   
                  ((ManageKidsFragment)getTargetFragment()).confirmDelete();          	   
               }
            })
