...
{   
   ...
   protected void onCreate(Bundle savedInstanceState)
   {
      ...
      { 
         ...
         arguments.putString(ItemDetailFragment.ITEM_ID, getIntent()
                  .getStringExtra(ItemDetailFragment.ITEM_ID));
         if (mType == Prefs.TYPE_WORD) { mFragment = new WordDetailFragment(); }
         else { mFragment = new QADetailFragment(); }
